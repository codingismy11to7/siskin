...
/**
 * Carries a non-HTTP [PlexFailure] across media3's ListenableFuture boundary.
 *
 ...
 */
class PlexTransportException(val failure: PlexFailure) : IOException(failure.toString())
