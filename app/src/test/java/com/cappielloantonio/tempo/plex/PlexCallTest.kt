...
class PlexCallTest {
    ...
    @Test
    fun wrapsASuccessfulCallInRight() =
        runTest {
    ...
    @Test
    fun mapsAnIOExceptionToUnreachableCarryingTheHost() =
        runTest {
    ...
    @Test
    fun mapsAnHttpExceptionToHttpCarryingTheHostAndCode() =
        runTest {
    ...
    @Test
    fun keepsTheHostsDistinctSoTheSameFailureReadsDifferently() =
        runTest {
    ...
    @Test
    fun letsCancellationEscapeRatherThanTurningItIntoAFailure() =
        runTest {
    ...
    @Test
    fun letsAnUnexpectedThrowableEscape() =
        runTest {
