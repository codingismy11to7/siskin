...
class SearchServiceTest {
    ...
    private fun service(): SearchService = Retrofit.Builder()
        .baseUrl(server.url("/"))
    ...
    @Test
    fun searchIsScopedToOneSection() = runTest {
    ...
    @Test
    fun getPlaylistsFiltersOnSectionIdNotLibrarySectionId() = runTest {
    ...
    @Test
    fun getPlaylistItemsReadsAPlaylistsTracks() = runTest {
        server.enqueue(MockResponse().setResponseCode(200).setBody("{}"))
    ...
    @Test
    fun reportProgressGetsTheColonTimelinePath() = runTest {
    ...
    @Test
    fun rateGetsTheColonRatePath() = runTest {
